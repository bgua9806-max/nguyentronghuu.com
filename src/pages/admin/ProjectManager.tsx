...
import { Plus, Search, Edit2, Trash2, Library, Filter, ExternalLink, Calendar, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <div className="bg-white rounded-sm border border-zinc-100 shadow-[0_2px_20px_rgba(0,0,0,0.04)] overflow-hidden">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
            ...
            <h3 className="font-serif text-2xl text-zinc-900 mb-2">Chưa có dự án nào</h3>
            <p className="text-zinc-500 max-w-sm mb-8 text-sm leading-relaxed">
              Thêm các case study và dự án nổi bật của bạn để gây ấn tượng với khách hàng và nhà tuyển dụng.
            </p>
            <Link 
              to="/admin/projects/new"
          ...
          <>
            ...
            <div className="px-8 py-5 border-t border-zinc-100 flex justify-between items-center bg-white">
              <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">Hiển thị <span className="text-zinc-900">1-{projects.length}</span> trên <span className="text-zinc-900">{projects.length}</span></span>
