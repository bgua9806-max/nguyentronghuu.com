...
export default function BlogList() {
  return (
    <motion.div
      ...
      className="py-32 bg-white px-6 md:px-12 min-h-screen"
    >
        ...
        <div className="border-t border-zinc-200">
          {BLOG_POSTS.map((post, idx) => (
            ...
            >
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-12 lg:gap-24 w-full">
                  <span className="w-32 text-sm font-medium text-zinc-400 shrink-0">{post.date}</span>
