...
const projectData = {
  ...
  seo_title: 'WorkTree X | Hệ Thống Điều Hành Công Việc & Quản Trị Đa Doanh Nghiệp',
  seo_description: 'Khám phá WorkTree X: Không gian điều hành công việc, quản lý dự án & phân quyền đa cấp theo cây tổ chức, tích hợp 7 chế độ xem trực quan, đồng bộ Realtime và bảo mật Multi-Tenant chuẩn SaaS.',
  status: 'completed',
...
const postData = {
  ...
  cover_image: '/images/worktree-cover.png',
  status: 'published',
  seo_title: 'WorkTree X: Không Gian Điều Hành Công Việc & Quản Trị Đa Doanh Nghiệp (Multi-Tenant SaaS)',
  seo_description: 'Hành trình xây dựng WorkTree X: Giải quyết bài toán phân mảnh thông tin, phân quyền theo cây tổ chức, 7 góc nhìn quản trị và đồng bộ Realtime.',
  tags: ['WorkTree X', 'SaaS', 'Multi-Tenant', 'Product Engineering', 'Supabase', 'Realtime', 'Quản Trị Doanh Nghiệp'],
